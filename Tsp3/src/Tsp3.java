...
public class Tsp3 {
    ...
    public static class Point {
        ...
        /* 
        //Beginning of for loop to get all text files.

            for (int i = 0; i < folder.length; i++) {
                
                File f = new File("/Users/cbovell/Dropbox/tsp/allTables/table00" + "i.txt");
                Scanner sc = new Scanner(f);
                
                for (int i = 0; i < folder.length; i++) {
                    
                    File f2 = new File("/Users/cbovell/Dropbox/tsp/allTables/table00" + "(i+1.txt");
        ...
        public static class ImagePanel extends JPanel {
            ...
            public ImagePanel() {
                ...
                try {
                    img = ImageIO.read(new File("/Users/cbovell/tsp/allTables/gif/001_024.gif"));
            ...
            public void paintComponent(Graphics g) {
                ...
                for (int i = 0; i < len; i++) {
                    ...
                    //System.out.println("ID #s: " + tableACoords.get(i).getID() + " " + tableBCoords.get(j).getID() );
                    if (tableACoords.get(i).getID() > 0 && tableBCoords.get(j).getID() > 0) {
        ...
        public static class NewFrame extends JFrame {
            ...
            public NewFrame() throws IOException {
                BufferedImage img = ImageIO.read(new File("/Users/cbovell/tsp/allTables/gif/001_024.gif"));
        ...
        public static void main(String[] args) throws InterruptedException, IOException {
            ...
            fillArrays();
            findLargestAddPeaks(tableACoords, tableBCoords, 40, 40);
            ...
            for (int itr = 1; itr <= 100; itr++) {
                ...
                for (int i = 0; i < len; i++) {
                    ...
                    int matchA = tableACoords.get(i).getID();
                    int matchB = tableBCoords.get(j).getID();

                    //algorithm to find most common element in array
                ...
                System.out.println("Itr number: " + itr + ". Best distance for seed: " + seed + "is: " + bestDist);
            }
            //put the best dist for seed here?
        }
